...
- [ ] I have checked the [README documentation](https://github.com/auth0/angular-jwt/blob/master/README.md).
- [ ] I have checked the [Auth0 Community](https://community.auth0.com/) for related posts.
- [ ] I have checked for related or duplicate [Issues](https://github.com/auth0/angular-jwt/issues) and [PRs](https://github.com/auth0/angular-jwt/pulls).
